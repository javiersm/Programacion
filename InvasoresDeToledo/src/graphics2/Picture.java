...
public class Picture implements Shape
{
   ...
   public Picture(double width, double height)
   {
    ...
    public void translate(double dx, double dy)
    {
        x += dx;
        y += dy;
        //HE COMENTADO EL METODO PAINT PARA QUE NO CONSUMA DEMASIADOS RECURSOS PINTANDO A CADA MOVIMIENTO DE LOS PJ
        //Canvas.getInstance().repaint();
    }
    // LA HE CREADO YO PARA MOVER LOS MISILES EN EL EJE Y
    ...
    /**
     * Hide this picture on the canvas.
     */
    public void undraw()
    {
